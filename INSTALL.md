...
4. Download fltk-1.4.0rc2-source.tar.bz2 or fltk-1.4.0rc2-source.tar.gz from [**fltk.org**](https://www.fltk.org/software.php) to a new **tilemap-studio-master\lib** subfolder.
5. Extract fltk-1.4.0rc2-source.tar (you may need a program such as [7-Zip](https://www.7-zip.org/)). This will create the lib\\**fltk-1.4.0rc2** folder.
6. Open Visual Studio, select **Open a local folder**, and open the lib\fltk-1.4.0rc2 folder. This will automatically generate the CMake project with a configuration named **x64-Debug** by default.
...
10. Move all the .lib files from lib\fltk-1.4.0rc2\out\build\x86-Release\lib\\\*.lib up to lib\\\*.lib.
11. Copy the lib\fltk-1.4.0rc2\\**FL** folder to a new include\\**FL** folder. Also copy lib\fltk-1.4.0rc2\out\build\x86-Release\FL\fl_config.h into include\FL.
...
# Build FLTK 1.4.0
git clone --branch release-1.4.0rc2 --depth 1 https://github.com/fltk/fltk.git lib/fltk
pushd lib/fltk
